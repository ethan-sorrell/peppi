...
use super::{
    action_state, attack, buttons, character, item,
...
frame_data!(Start { random_seed: u32 }, {});
...
pub struct Frame {
    pub port1: Option<PortData>,
    pub port2: Option<PortData>,
    pub port3: Option<PortData>,
    pub port4: Option<PortData>,
...
impl Serialize for Frame {
        ...
        S: serde::Serializer,
    {
        ...
        state.serialize_field("port1", &self.port1)?;
        state.serialize_field("port2", &self.port2)?;
        state.serialize_field("port3", &self.port3)?;
        state.serialize_field("port4", &self.port4)?;
